...
public:
  ...
  void run()
  {
	...
	file_count++;
      ...
      cout << " kinectPoint.x = " << kinect_point.x * 10 << " kinectPoint.y = " << kinect_point.y * 10 << endl;
